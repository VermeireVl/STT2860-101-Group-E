...
author: "Viktor Vermeire, Ayden Matocha, "
...
**ANSWER:** (I would agree because since they have higher muscle mass it raises their BMI and they could be considered unhealthy although they are great athletes. BFP would be a much better measurement) 
...
```{r playtimeboxplot}
ggplot(nflplayers, aes(x = Playtime)) + geom_bar(fill = "#0073C2FF", color = "white") + scale_y_continuous(breaks = seq(0,max(table(nflplayers$Playtime)) + 100, by = 100)) + labs(title = "Distribution of NFL Player Playtime", subtitle = "Playtime levels across all recorded players",
...
```{r ageviolins}
ggplot(nflplayers, aes(x = Age, y = Side)) + geom_violin(fill = "#B3CDE3", color = "gray40", alpha = 0.8) + geom_boxplot(width = 0.15, fill = "#005B96", color = "white", outlier.size = 2.5) + labs( title = "Distribution of NFL Player Ages by Field Side", subtitle = "Comparison of player ages across offense, defense, and special teams", x = "Age (years)", y = "Side of Play") + theme_light(base_size = 14)
```
...
**The plots show that most NFL players have short careers with most of them under 10 years. This includes active players in their mid-20s to early 30s. While playtime and age vary across both sides of the ball, the majority of players see shorter playtime and careers. These plots however, don't do a good job explaining why careers are short. This could be due to injuries or the nature of football. To improve on this they could show how career length changes over time due to injuries.** 
